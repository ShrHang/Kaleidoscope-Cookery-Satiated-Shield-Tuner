...
public class Config {
    ...
    public static final ForgeConfigSpec.BooleanValue IS_MODIFY_SATIATED_SHIELD;
    public static final ForgeConfigSpec.BooleanValue IS_SATIATED_SHIELD_DISABLE_WHEN_HUNGRY_EFFECT;
    public static final ForgeConfigSpec.IntValue SATIATED_SHIELD_MIN_FOOD_LEVEL;
    public static final ForgeConfigSpec.DoubleValue SATIATED_SHIELD_ADDITIONAL_EXHAUSTION_PER_DAMAGE;
    public static final ForgeConfigSpec.DoubleValue SATIATED_SHIELD_DAMAGE_REDUCTION_PERCENT;
    public static final ForgeConfigSpec.DoubleValue SATIATED_SHIELD_MAX_DAMAGE_REDUCTION;
    public static final ForgeConfigSpec.DoubleValue SATIATED_SHIELD_MIN_DAMAGE;
    public static final ForgeConfigSpec.DoubleValue SATIATED_SHIELD_WEAKNESS_DAMAGE_MULTIPLIER;
